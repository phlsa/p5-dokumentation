...
Timeline timeline3 = new Timeline(RECT);
Timeline timeline4 = new Timeline(RECT);
Timeline timeline5 = new Timeline(TRIANGLE);
Timeline timeline6 = new Timeline(TRIANGLE);
...
void setup() {
  ...
  // keyframes:
  // Time, Property (X,Y,W,H,A), Value, optional: Easing
